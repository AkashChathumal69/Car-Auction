  ...
  return (
    <div className="flex flex-col justify-center container md:mt-16 py-10">
      <h1 className=" font-bold text-4xl text-center">
        Why choose <span className=" text-primary">BidWheels</span>?
      </h1>

      <p className=" text-center">
      <p>Our certified technicians provide expert maintenance and repair services. Schedule your appointment today.</p>
      <p>Trade in your old vehicle and get a fair appraisal. We accept all makes and models.</p>
      </p>
